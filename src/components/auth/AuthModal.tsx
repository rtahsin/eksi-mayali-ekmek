              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    if (res?.success) {
                      setSuccessMsg("Google ile giriş başarılı! Hoş geldiniz.");
                      setTimeout(() => {
                        onClose();
                      }, 600);
                    } else if (res?.error) {
                ...
                disabled={submitting}
                className="w-full py-2.5 px-4 rounded-xl bg-surface-elevated hover:bg-surface border border-surface-border text-foreground font-sans text-xs font-semibold flex items-center justify-center gap-2.5 transition-all shadow-sm hover:border-artisan-gold/40"
              >
